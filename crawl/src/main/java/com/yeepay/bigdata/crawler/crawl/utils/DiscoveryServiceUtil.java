...
public class DiscoveryServiceUtil {
    ...
    public DiscoveryServiceUtil(ServiceType nodetype, String basePath, String zkAddress) {
    ...
    private boolean regist(ServiceInstance instance) {
        ...
        boolean ret = false;
        try {
            CuratorFramework client = CuratorFrameworkFactory.newClient(zkAddress, new RetryOneTime(2));
...
//            }
    ...
    public boolean removeService(String serviceName, String address, int port) {
        ...
        boolean ret = false;
        try {
            CuratorFramework client = CuratorFrameworkFactory.newClient(zkAddress, new RetryOneTime(1));
            closeables.add(client);
            client.start();
    ...
    protected void forceDelete(String serviceName) throws IOException {
